 ...
 * 
 */
const xRefTest      = "ACH_TSP_ADD";
const xDescription  = "Créer une unité de Transport";
const xIdTest       =  1640;
const xVersion      = "3.0";
...
var info = {
    ...
    refTest     : [xRefTest],
    idTest      : xIdTest,
    help        : ['Precursseur de [ACH_TSP_MOD]'],
    params      : [],
    fileName    : __filename
};
   ...
   test('Connexion', async() => {
    ...
    test.describe('Page [REFERENTIEL]', async() => {
       ...
       test.describe('Onglet [UNITES DE TRANSPORT]', async() => {
            ...
            test ('Button [CREER UNE UNITE DE TRANSPORT] - Click', async () => {
                await fonction.clickElement(pageref.buttonCreerUniteTransport);
            })
